...
const Home = () => {
    const { books: { all, popular, most_rated }, user: { genres, accessToken } } = useSelector(state => state);
            ...
            <div className="home">
                {
                    ...
                    <div className="main-page">
                        <section className="left">
                            ...
                            <h2>
                                Aliquip eu pariatur irure nulla sunt reprehenderit et est anim est nisi aliqua occaecat.
                    </h2>
                            <div className="sign-upbtn" onClick={() => history.push('/sign-up')}>
                                <span className="hash">
                                    Explore Now
                        </span>
